...
a JSMutable pode ser sua opção, entretando leve em consideração que na versão 1.0 esta biblioteca suporta somente serializar
...
várias ocasiôes a biblioteca será suficiente em outros não. Apesar de estar na versão 1.0 a biblioteca está bem estável já
